...
namespace AcademicSystem
{
    public partial class Form9 : Form
    {
        ...
        private void Form9_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("select * from student where student_code=@student_code", conn);
            adapter.SelectCommand.Parameters.Add("@student_code", SqlDbType.VarChar, 1000).Value = studentcode;
